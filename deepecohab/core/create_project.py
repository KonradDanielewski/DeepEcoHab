...
def create_ecohab_project(
    ...
    Args:
        ...
        start_datetime: full date and time of the proper start of the experiment. Expected format 'yyyy-mm-dd HH:MM:SS.ffffff'. If not provided, extracted from data.
        finish_datetime: full date and time of the proper end of the experiment. Rest same as start.
        experiment_name: name of the experiment.
        dark_phase_start: hour, minute, second, milisecond of the dark phase start.
        light_phase_start: hour, minute and second of the light phase start.
        animal_ids: if not provided reads animal ids from the first file with data.
        custom_layout: change to True if using multiple boards at the same time during one recordig with a custom arena geometry.
        field_ecohab: change to True if the data is from a field ecohab.
